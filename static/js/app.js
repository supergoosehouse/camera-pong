...
socket.on("updateFingersPositions", function (msg) {
  ...
  playerRacket.x1 = msg.x1 * canvas.style.width;
  playerRacket.y1 = msg.y1 * canvas.style.height;
  playerRacket.x2 = msg.x2 * canvas.style.width;
  playerRacket.y2 = msg.y2 * canvas.style.height;
